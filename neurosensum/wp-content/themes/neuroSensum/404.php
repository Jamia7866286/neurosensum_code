...
<section class="wrapper">
    <div class="contentmain center">
        <div id="content" class="narrowcolumn">
            <p class="emoji wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">:(</p>
            <center><h2 class="title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">Error 404 - <span>Page Not Found</span></h2></center>
        </div>
        <div class="center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
            <p>You 
                <?php
