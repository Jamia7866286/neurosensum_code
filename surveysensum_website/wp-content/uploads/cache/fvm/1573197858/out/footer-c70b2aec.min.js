...
(function(a){a.fn.niceSelect=function(d){if(typeof d=="string"){if(d=="update"){this.each(function(){var f=a(this);var g=a(this).next(".nice-select");var e=g.hasClass("open");if(g.length){g.remove();c(f);if(e){f.next().trigger("click")}}})}else{if(d=="destroy"){this.each(function(){var e=a(this);var f=a(this).next(".nice-select");if(f.length){f.remove();e.css("display","")}});if(a(".nice-select").length==0){a(document).off(".nice_select")}}else{console.log('Method "'+d+'" does not exist.')}}return this}this.hide();this.each(function(){var e=a(this);if(!e.next().hasClass("nice-select")){c(e)}});function c(g){g.after(a("<div></div>").addClass("nice-select").addClass(g.attr("class")||"").addClass(g.attr("disabled")?"disabled":"").attr("tabindex",g.attr("disabled")?null:"0").html('<span class="current"></span><ul class="list"></ul>'));var h=g.next();var e=g.find("option");var f=g.find("option:selected");h.find(".current").html(f.data("display")||"<img src='"+f.attr("data-image")+"' width='50'>"+f.text());e.each(function(j){var l=a(this);var k=l.data("display");h.find("ul").append(a("<li></li>").attr("data-value",l.val()).attr("data-image",l.attr("data-image")).attr("data-display",(k||null)).addClass("option"+(l.is(":selected")?" selected":"")+(l.is(":disabled")?" disabled":"")).html("<img src='"+l.attr("data-image")+"' width='50'>"+l.text()))})}a(document).off(".nice_select");a(document).on("click.nice_select",".nice-select",function(e){var f=a(this);a(".nice-select").not(f).removeClass("open");f.toggleClass("open");if(f.hasClass("open")){f.find(".option");f.find(".focus").removeClass("focus");f.find(".selected").addClass("focus")}else{f.focus()}});a(document).on("click.nice_select",function(e){if(a(e.target).closest(".nice-select").length===0){a(".nice-select").removeClass("open").find(".option")}});a(document).on("click.nice_select",".nice-select .option:not(.disabled)",function(e){var g=a(this);var f=g.closest(".nice-select");f.find(".selected").removeClass("selected");g.addClass("selected");var h=g.data("display")||"<img src='"+g.attr("data-image")+"' width='50'>"+g.text();f.find(".current").html(h);f.prev("select").val(g.data("value")).trigger("change")});a(document).on("keydown.nice_select",".nice-select",function(g){var h=a(this);var i=a(h.find(".focus")||h.find(".list .option.selected"));if(g.keyCode==32||g.keyCode==13){if(h.hasClass("open")){i.trigger("click")}else{h.trigger("click")}return false}else{if(g.keyCode==40){if(!h.hasClass("open")){h.trigger("click")}else{var e=i.nextAll(".option:not(.disabled)").first();if(e.length>0){h.find(".focus").removeClass("focus");e.addClass("focus")}}return false}else{if(g.keyCode==38){if(!h.hasClass("open")){h.trigger("click")}else{var f=i.prevAll(".option:not(.disabled)").first();if(f.length>0){h.find(".focus").removeClass("focus");f.addClass("focus")}}return false}else{if(g.keyCode==27){if(h.hasClass("open")){h.trigger("click")}}else{if(g.keyCode==9){if(h.hasClass("open")){return false}}}}}}});var b=document.createElement("a").style;b.cssText="pointer-events:auto";if(b.pointerEvents!=="auto"){a("html").addClass("no-csspointerevents")}return this}}(jQuery));
...
(function($){"use strict";$(window).on("load",function(){$(".preloader").delay(200).fadeOut("slow")});$('.dropdown-menu').each(function(){$(this).find('li').wrapAll("<div class='dropdown-item-container'></div>")})
