...
function cmb2_sample_metaboxes() {
	...
	$cmb = new_cmb2_box( array(
		'id'            => 'test_metabox',
		'title'         => __( 'CX Metabox', 'cmb2' ),
		'object_types'  => array( 'cx', ), // Post type
		'context'       => 'normal',
		'priority'      => 'high',
		'show_names'    => true,
	));
	...
	///////// Image if video is not avalible

	// $cmb->add_field( array(
	// 	'name'    => 'If video is not available',
	// 	'desc'    => 'Upload an image or enter an URL.',
	// 	'id'      => 'image_if_video_unavailable',
	// 	'type'    => 'file',
	// 	// Optional:
	// 	'options' => array(
	// 		'url' => false,
	...
	$group_field_id = $cmb->add_field( array(
		...
		//'description' => __( 'Generates reusable form entries', 'cmb2' ),
		'options'     => array(
			'group_title'       => __( 'if video is not available {#}', 'cmb2' ),
			//'add_button'        => __( 'Add Another Entry', 'cmb2' ),
			//'remove_button'     => __( 'Remove Entry', 'cmb2' ),
			'sortable'          => true,
		),
	...
	$group_field_id = $cmb->add_field( array(
		...
		'description' => __( 'Generates reusable form entries', 'cmb2' ),
		'options'     => array(
			'group_title'       => __( 'Who should attend {#}', 'cmb2' ),
			'add_button'        => __( 'Add Another Entry', 'cmb2' ),
			'remove_button'     => __( 'Remove Entry', 'cmb2' ),
			'sortable'          => true,
		),
	...
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Who should attend (heading)',
		'id'   => 'attend_heading',
		'type' => 'text',
	) );
	
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Who should attend (image)',
		'id'   => 'attend_images',
		'type' => 'file',
	) );
	...
	$group_field_id = $cmb->add_field( array(
		...
		'description' => __( 'Generates reusable form entries', 'cmb2' ),
		'options'     => array(
			'group_title'       => __( 'About Speakers {#}', 'cmb2' ),
			'add_button'        => __( 'Add Another Entry', 'cmb2' ),
			'remove_button'     => __( 'Remove Entry', 'cmb2' ),
			'sortable'          => true,
		),
	...
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Speaker Name',
		'id'   => 'about_speakers_name',
		'type' => 'text',
	) );
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Speaker Professions',
		'id'   => 'speaker_professions',
		'type' => 'text',
	) );
	...
	$cmb->add_field( array(
		'name'    => 'Button Text (Watch Now or Register Now)',
		'desc'    => 'Watch Now',
		'default' => 'Watch Now',
		'id'      => 'button_text',
		'type'    => 'text',
...
function cx_post_type() {
 
	$labels = array(
	    'name'                => _x( 'cx', 'Post Type General Name'),
	    'singular_name'       => _x( 'cx', 'Post Type Singular Name'),
	    'add_new'             => __( 'Add New', 'Cx'),
	    'add_new_item'        => __( 'Add New Cx', ),
	    'edit_item'           => __( 'Edit Cx'),
	    'new_item'            => __( 'New Cx' ),
	    'all_items'           => __( 'All Cx' ),
	    'view_item'           => __( 'View Cx' ),
	    'search_items'        => __( 'Search Cx'),
	    'not_found'           => __( 'Not Cx Found'),
	    'not_found_in_trash'  => __( 'Not Cx found in Trash'),
	    'parent_item_colon'   => '',
	    'menu_name'           => __( 'Cx'),    
	);
	...
	$args = array(
	    'label'               => __( 'cx' ),
	    'description'         => __( 'cx news and reviews' ),
	    'labels'              => $labels,
	...
	register_post_type( 'cx', $args );
   
}
add_action( 'init', 'cx_post_type', 0 );
  
  
//create a custom taxonomy name it "type" for your posts
function create_services_posttype_taxonomy() {
	...
	register_taxonomy('topic',array('cx'), array(
	'hierarchical' => true,
	'labels' => $labels,
	'show_ui' => true,
...
add_action( 'init', 'create_services_posttype_taxonomy', 0 );
...
/****************  Case Studies, Custom field manually  ******************/

function cmb2_sample_metaboxes_study() {


	/************ Initiate the metabox ***********/

	$cmb = new_cmb2_box( array(
		'id'            => 'case_studies_metabox',
		'title'         => __( 'Case Study Metabox', 'cmb2' ),
		'object_types'  => array( 'customers', ), // Post type
		'context'       => 'normal',
		'priority'      => 'high',
		'show_names'    => true,
	));
	...
	//************ Resolving urgent issue Section 1
	$group_field_id = $cmb->add_field( array(
		'id'          => 'resolve_urgent_section1_repeat_group',
		'type'        => 'group',
		'options'     => array(
			'group_title'       => __( 'Banner Section 1', 'cmb2' ),
			'sortable'          => true,
		),
	) );
	
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Small Overline Text',
		'id'   => 'small_company_title',
		'type' => 'text',
	) );
	
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Resolving Heading',
		'id'   => 'resolving_heading_section1',
		'type' => 'text',
	) );



	//************ Company Achieved Section 2
	$group_field_id = $cmb->add_field( array(
		'id'          => 'achieve_section2_repeat_group',
		'type'        => 'group',
		'options'     => array(
			'group_title'       => __( 'What Company has achieved? Section 2', 'cmb2' ),
			'sortable'          => true,
		),
	) );
	
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Company Achieve Text',
		'id'   => 'company_text',
		'type' => 'text',
	) );

	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Company Achieve Point 1, Number Text',
		'id'   => 'achieve_point_1_number',
		'type' => 'text',
	) );
	
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Company Achieve Point 1',
		'id'   => 'achieve_point_1',
		'type' => 'text',
	) );
	...
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Company Achieve Point 2, Number Text',
		'id'   => 'achieve_point_2_number',
		'type' => 'text',
	) );

	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Company Achieve Point 2',
		'id'   => 'achieve_point_2',
		'type' => 'text',
	) );
	...
	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Company Achieve Point 3, Number Text',
		'id'   => 'achieve_point_3_number',
		'type' => 'text',
	) );

	$cmb->add_group_field( $group_field_id, array(
		'name' => 'Company Achieve Point 3',
		'id'   => 'achieve_point_3',
		'type' => 'text',
	) );
	...
	//************ Profile Section 3
	$group_field_id = $cmb->add_field( array(
		'id'          => 'profile_section3_repeat_group',
		'type'        => 'group',
		'options'     => array(
			'group_title'       => __( 'Profile Section 3', 'cmb2' ),
			'sortable'          => true,
		),
	) );
	...
	//************ Solution Section 6
	$group_field_id = $cmb->add_field( array(
		'id'          => 'solution_section6_repeat_group',
		'type'        => 'group',
		'options'     => array(
			'group_title'       => __( 'The Solution, Section 6 point {#}', 'cmb2' ),
			'add_button'        => __( 'Add Another Entry', 'cmb2' ),
			'sortable'          => true,
		),
	) );
	...
	//************ Solve the problem Section 7
	$group_field_id = $cmb->add_field( array(
		'id'          => 'solve_problem_section7_repeat_group',
		'type'        => 'group',
		'options'     => array(
			'group_title'       => __( 'How did it solve the problem {#} ? Section 7', 'cmb2' ),
			'add_button'        => __( 'Add Another Entry', 'cmb2' ),
			'sortable'          => true,
		),
	) );
	...
	//************ About the Company Section 8
	$group_field_id = $cmb->add_field( array(
		'id'          => 'about_company_section8_repeat_group',
		'type'        => 'group',
		'options'     => array(
			'group_title'       => __( 'About the Company, Section 8 point {#}', 'cmb2' ),
			'add_button'        => __( 'Add Another Entry', 'cmb2' ),
			'sortable'          => true,
		),
	) );
	...
	//************ Company Logo upload for about company section 8
	$cmb->add_field( array(
		'name'    => 'Company Logo',
		'id'      => 'company_logo',
		'type'    => 'file',
...
add_action( 'cmb2_admin_init', 'cmb2_sample_metaboxes_study' );
...
function case_studies_post_type() {
	...
	$labels = array(
	    ...
	    'not_found'           => __( 'Not Case Studies Found'),
	    'not_found_in_trash'  => __( 'Not Case Studies found in Trash'),
	    'parent_item_colon'   => '',
	...
	$args = array(
	    ...
	    'description'         => __( 'case studies news and reviews' ),
	    'labels'              => $labels,
	    'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields', ),
	    'taxonomies'          => array( 'genres' ),
	    'hierarchical'        => false,
...
//**************************** Ebook post type, Custom field manually ************************
...
function ebook_post_type() {
	...
	$labels = array(
	    ...
	    'singular_name'       => _x( 'Ebooks', 'Post Type Singular Name'),
	    'add_new'             => __( 'Add New', 'Ebooks'),
	    'add_new_item'        => __( 'Add New Ebooks', ),
	    'edit_item'           => __( 'Edit Ebooks'),
	    'new_item'            => __( 'New Ebooks' ),
	    'all_items'           => __( 'All Ebooks' ),
	    'view_item'           => __( 'View Ebooks' ),
	    'search_items'        => __( 'Search'),
	    'not_found'           => __( 'Not Ebooks Found'),
	    'not_found_in_trash'  => __( 'Not Ebooks found in Trash'),
	    'parent_item_colon'   => '',
	    'menu_name'           => __( 'Ebooks'),    
	);
	...
	$args = array(
	    'label'               => __( 'Ebooks' ),
	    'description'         => __( 'Ebooks news and reviews' ),
	    'labels'              => $labels,
	    'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields', ),
	    'taxonomies'          => array( 'genres' ),
	    'hierarchical'        => false,
