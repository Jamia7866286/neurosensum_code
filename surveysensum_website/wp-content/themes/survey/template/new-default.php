			...
			<div class="row">
				<div class="col">
					<div class="post-tp">
						...
						<div class="date-time">
							<figure class="author-image"><?php echo get_avatar( get_the_author_meta( 'ID' ), 44 ); ?></figure>
					...
					<div class="sidebar">
						<div class="newsletter">
							...
							<div class="form-container">
								...
								<?php #gravity_form(5, false, false, false, '', true, 50); ?>
								...
								<script type="text/javascript" src="https://tgqv.maillist-manage.in/js/optin.min.js" onload="setupSF('sf3z18938d901850824a5a5fe149e48f83e86c32d44363dfe2254860a48417c4ed67','ZCFORMVIEW',false,'light',false,'0')"></script>
									...
									<div id="customForm">
										...
										<div>
											...
											<form method="POST" id="zcampaignOptinForm" style="margin: 20px 0 0; width: 100%" action="https://maillist-manage.in/weboptin.zc" target="_zcSignup">
											...
											<div style="color: rgb(242, 100, 77); margin: 0; border: 1px none rgb(255, 217, 211); opacity: 1; font-size: 12px; font-family: Arial; width: 202px; height: auto; display: none;font-weight:500;" id="errorMsgDiv">Email must be formatted correctly.
											<br>
											</div>
											</form>
										</div>
						...
						<div class="trending-articles">
							...
							<?php if( have_rows('sidebar_related_articles') ): while( have_rows('sidebar_related_articles') ): the_row();  ?>
							<div class="post-single">
								<div class="post-content">
									<a class="category" href="<?php the_sub_field('category_link');?>"><?php the_sub_field('category_name');?> </a>
									<h2 class="post-title">
										<a href="<?php the_sub_field('category_link');?> ">  <?php the_sub_field('post_title');?> </a>
									</h2>
									<a class="read-more" href="<?php the_sub_field('category_link');?>">Read More <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/arrow-blue-right.svg" alt="" /></a>
								</div>
							</div>
							<?php   endwhile;  endif; ?>
						</div>
...
<section class="related-content-section">
	<div class="container">
		<div class="related-content-inner">
			...
			<div class="row">
				<?php if( have_rows('bottom_related_articles') ): while( have_rows('bottom_related_articles') ): the_row();  ?>
				<div class="col-md-4">
				<div class="post-single post-small">
				<figure>
						<a href="<?php the_sub_field('post_link');?>">
						<img src="<?php the_sub_field('post_image');?>" alt="<?php the_sub_field('image_alt');?>" />
						</a>
					</figure>
					<div class="post-content">
					<a class="category" href="<?php the_sub_field('category_link');?>"><?php the_sub_field('category_name');?> </a>
					<h2 class="post-title">
					<a href="<?php the_sub_field('post_link');?>"><?php the_sub_field('post_title');?> </a>
					</h2>
					<a href="<?php the_sub_field('post_link');?>" class="read-more">Read More <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/arrow-blue-right.svg" alt="" /></a>
					</div>
				</div>
