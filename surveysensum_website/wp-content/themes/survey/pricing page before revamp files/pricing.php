...
const Interval = {
  ...
  function getSavedAmount(price){
    var discount=<?php echo $discount; ?>;
    if (switchStatus) {
      return Math.round((price*discount /100) * 12);
    } else {
  ...
  function renderPlanPrices(){
    $('[data-planid]').each(function(){
      ...
      var discountedPrice =getDiscountedPrice(planPrice);
      var savedAmount=getSavedAmount(planPrice);
      $(this).find('.price-change-monthly').html(planPrice);
      
      $(this).find('.price-change-monthly').html(discountedPrice);

      $(this).find('.priceChange sup span').html(planPrice);

      $(this).find('.save-amount span').html(savedAmount);
                    ...
                    <div class="cx-platform">
                      ...
                      <div class="top-cards-large">
                        ...
                        <div class="save-money">
                          ...
                          <div class="togglex-btn d-flex align-items-center justify-content-center">
                              ...
                              <div class="plans-card">
                                ...
                                <div class="card large-card-top <?php if($ip_info['countryCode'] == $hide_plans_for){echo 'hide-price';} ?>">
                                  <div class="card-body">
                                      ...
                                      <a href="https://portal.surveysensum.com/register" class="btn btn-outline-primary lg" id="basic-signup-free">Get Started for free</a>
                                ...
                                <div class="card large-card-top <?php if($plan['isBestValue'] == True){echo 'active';} ?> <?php if($ip_info['countryCode'] == $hide_plans_for){echo 'hide-price';} ?>" <?php echo 'data-planid="'.$plan['ssPlanId'].'"';?>>
                                  <div class="card-body">
                                    ...
                                    <h3 class="card-title dynamic-cards-plan">
                                      <span><?php echo $plan['name']; ?></span>
                                      <div class="save-amount">Save <?php echo $currentSymbol; ?><span></span></div>
                                    </h3>
                                    ...
                                    <div class="strikethrough-main strike-d-block-none">
                                        <h4 class="amount-free year-months-text">
                                            <div class="priceChange">
                                                  ...
                                                  <sup><?php echo $currentSymbol; ?><span class="price-change-monthly"></span></sup>
                                            </div>
                                            <div class="creditCardRequired">per month<span></span></div>
                                        </h4>
                                    </div>

                                    <a href="https://portal.surveysensum.com/register" class="btn btn-outline-primary lg other-country-content" id="<?php echo $plan['name']; ?>">Get Started for free</a>
                                      ...
                                      <div class="plans-card d-flex cards-mob-desktop">
                                        ...
                                        <div class="card <?php if($ip_info['countryCode'] == $hide_plans_for){echo 'hide-price';} ?>">
                                          <div class="card-body">
                                              ...
                                              <a href="https://portal.surveysensum.com/register" class="btn btn-outline-primary lg request-pricing-small" id="basic-signup-free-3">Get Started for free</a>
                                          </div>
                                        </div>
                                        ...
                                        <?php foreach(getPaidPlans() as $plan): ?>
                                          <div class="card <?php if($plan['isBestValue'] == True){echo 'active';} ?> <?php if($ip_info['countryCode'] == $hide_plans_for){echo 'hide-price';} ?>" <?php echo 'data-planid="'.$plan['ssPlanId'].'"';?>>
                                            <div class="card-body">
                                              ...
                                              <a href="https://portal.surveysensum.com/register" class="btn btn-outline-primary lg other-country-content" id="professional-buy">Get Started for free</a>
                                  ...
                                  <div class="card pdf-card <?php if($ip_info['countryCode'] == $hide_plans_for){echo 'hide-price';} ?>">
                                    <div class="card-body">
                                        ...
                                        <a
                                          ...
                                          class="btn btn-outline-primary lg request-pricing-small" id="basic-signup-free-3">Get Started for free</a>
                                  ...
                                  <?php foreach(getPaidPlans() as $plan): ?>
                                    <div class="card pdf-card <?php if($plan['isBestValue'] == True){echo 'active';} ?> <?php if($ip_info['countryCode'] == $hide_plans_for){echo 'hide-price';} ?>" <?php echo 'data-planid="'.$plan['ssPlanId'].'"';?>>
                                      <div class="card-body">
                                        ...
                                        <a href="https://portal.surveysensum.com/register" class="btn btn-outline-primary lg other-country-content" id="buy-now-3">Get Started for free</a>
