<?php function bottomSubscribe(){ ?> 
    <section class="bottom-subscribe">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="bottom-subscribe-inner bottomSubscribe">
                        <div class="round-top">
                        </div>
                        <h3>Stay up-to-date with latest CX tips and tricks, subscribe now!</h3>
                        <?php #gravity_form(4, false, false, false, '', true, 56); ?>
                                    ...
                                    <div id="customForm">
                                        ...
                                        <div>
                                            ...
                                            <form method="POST" id="zcampaignOptinForm" style="margin: 0px; width: 64%;" action="https://maillist-manage.in/weboptin.zc" target="_zcSignup">
                                            <div class="zoho-newsletter-form" style="position: relative; margin: 0; display: inline-block; height: 54px; width: 360px;">
                                            ...
                                            <div class="zoho-newsletter-btn" style="position: relative; margin: 0 0 0 30px; text-align: left; display: inline-block; height: 54px; width: 166px;">
                        ...
                        <small>Don’t worry, we don’t spam you.</small>
